...
namespace Gui
{
    ...
    class SoundInterface: virtual public SP_Info
    {
    public:
        ...
        virtual void PlaySound(SndHndl snd, int nChannel = -1, bool bLoop = false)=0;
    ...
    template<class T>
    class DummySoundInterface: public SoundInterface<T>
    {
    ...
    template<class SndHndl>
    void SimpleSoundInterface<SndHndl>::
        DeleteSound(Index snd)
    {}

    template<class SndHndl>
    Index SimpleSoundInterface<SndHndl>::
        LoadSound(std::string sFile)
    {
    ...
    template<class SndHndl>
    void SimpleSoundInterface<SndHndl>::
        PlaySound(Index snd, int nChannel, bool bLoop)
    {
