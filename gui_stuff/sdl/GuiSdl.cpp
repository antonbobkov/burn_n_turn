...
namespace Gui
{
    ...
    */
    ...
    void SdlGraphicalInterface::RefreshAll()
    {
		...
		{
			RectangleOnto(pScreen, Rectangle(Point(0,0), Size(rOffSet.p.x, sz.y)), Color(0,0,0));
			RectangleOnto(pScreen, Rectangle(Point(0,0), Size(sz.x, rOffSet.p.y)), Color(0,0,0));
			
			RectangleOnto(pScreen, Rectangle(Point(rOffSet.Right(),  0),
				Size(sz.x - rOffSet.Right(), sz.y)), Color(0,0,0));

			RectangleOnto(pScreen, Rectangle(Point(0, rOffSet.Bottom()),
