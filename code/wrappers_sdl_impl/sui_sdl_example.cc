/*
 * sui_sdl_example - Load and play music and sound effects using SuiSdl (SuiGen + SDL_mixer).
 *
...
int main(int argc, char** args)
{
	...
	SDL_Window* window = SDL_CreateWindow("sui_sdl_example",
	...
	if (soundLoaded) soundIf.DeleteSound(sndIndex);
	pSnd = 0;
